...
function paramsResults(){
    ...
    var t = document.createTextNode("CONFUSIOOOOOOON"); 
    display2.appendChild(t);
    document.body.appendChild(display2);
    var papa2 = document.getElementById("childElement2");
    var parentDiv2 = papa2.parentNode;
    parentDiv2.insertBefore(display2, papa);
}
...
function reuseparameters(){
    ...
    alert ("soon available, better take original variable and \
     not textarea element as user can damage text unintentionnally !");
    tired();
